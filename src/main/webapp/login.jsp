...
<head>
    ...
    <title>Вітаємо в інтернет-магазині</title>
</head>
...
<div class="login-page">
    <div class="form">
        <form class="register-form">
            <input class="firstName" type="text" placeholder="Імя" />
            ...
            <button class="register" type="button">Зареєструватись</button>
            <p class="message">Уже створили акаунт? <a href="#">Увійти</a></p>
        </form>
        <form class="login-form">
            <input class="email" type="text" placeholder="Логін" />
            <input class="password" type="password" placeholder="Пароль" />
            <button class="login" type="button">Увійти</button>
            <p class="message">Ще не зареєстровані? <a href="#">Зареєструватись</a></p>
        </form>
    </div>
</div>
